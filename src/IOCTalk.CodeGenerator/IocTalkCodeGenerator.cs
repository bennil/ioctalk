...
namespace IOCTalk.CodeGenerator
{
    ...
    public class IocTalkCodeGenerator : IIncrementalGenerator
    {
        ...
        private const string MethodNameRegisterAutoGeneratedProxyInterfaceMappings = "RegisterAutoGeneratedProxyInterfaceMappings";
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            var autoGenEnabledIndicator = context.SyntaxProvider
                                .CreateSyntaxProvider(CollectRegisterAutoGeneratedProxyInterfaceMappingsDeclarations, GetMethodInvokeIndicator)
                                .Collect();
        ...
        private bool CollectRegisterAutoGeneratedProxyInterfaceMappingsDeclarations(SyntaxNode syntaxNode, CancellationToken cancellationToken)
        {
            ...
            if (syntaxNode is InvocationExpressionSyntax invokeExp
                && invokeExp.Expression != null)
            {
                string? name = invokeExp.Expression.TryGetInferredMemberName();
                if (name != null
                    && name == MethodNameRegisterAutoGeneratedProxyInterfaceMappings)
                {
                    return true;
                }
            }
        ...
        private bool GetMethodInvokeIndicator(GeneratorSyntaxContext context, CancellationToken cancellationToken)
        {
        ...
        private StringBuilder BuildEmptyRegistrationMappingsSource(string assemblyName)
        {
            ...
            sb.AppendLine("     public static void RegisterAutoGeneratedProxyInterfaceMappings(this TalkCompositionHost ctx)");
            sb.AppendLine("     {");
            sb.AppendLine($"         // Empty method body because no {MethodNameRegisterAutoGeneratedProxyInterfaceMappings}() call was found in assembly: {assemblyName}");
            sb.AppendLine($"         // Add this container registration to activate auto code generation.");
            sb.AppendLine("     }");
