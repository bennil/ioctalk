...
// This is a copy from https://github.com/Microsoft/bond/blob/master/cs/src/core/io/safe/InputBuffer.cs with the ability to change the underlying byte array from the outside
...
namespace Bond.IO.Safe
{
    ...
    public class InputBuffer //: IInputStream, ICloneable<InputBuffer>
    {
        ...
        public void UpdateBuffer(byte[] data, int offset, int length)
        {
            this.buffer = data;
            this.offset = offset;
            end = offset + length;
