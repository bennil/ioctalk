...
namespace BSAG.IOCTalk.Serialization.Binary.TypeStructure.Values
{
    ...
    public class UInt64Item : AbstractValueItem
    {
        /// <summary>
        ...
        public UInt64Item(string name, Func<object, object> getter, Action<object, object> setter)
                    : base(name, getter, setter, ItemType.UInt64)
        {
        }
