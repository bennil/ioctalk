...
namespace BSAG.IOCTalk.Serialization.Binary.TypeStructure.Values
{
    ...
    public class Int32Item : AbstractValueItem
    {
        /// <summary>
        ...
        public Int32Item(string name, Func<object, object> getter, Action<object, object> setter)
                    : base(name, getter, setter, ItemType.Int32)
        {
        }
